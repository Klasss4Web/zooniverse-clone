...
const GetInvolvedPage = () => (
    <div className="">
      <Banner title="Get Involved" active="Volunteering" paused="Education" finished="Call For Projects" ackn="Acknowledgements"/>
      <div className="container text-left">
        <div className="content-container">
          ...
          <h2>Volunteer as a Beta Tester</h2>
          ...
          <h2>Volunteer on a Moderator</h2>
